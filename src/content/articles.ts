...
`
  },
  {
    ...
    title: "ドコモ・au・ソフトバンク セキュリティ比較2026｜3社中最下位は40点だった",
    description: "大手通信キャリア3社のWebセキュリティを10項目で独自採点。平均53点の衝撃結果…DMARC全社未設定でフィッシング対策はほぼゼロ。あなたが使っているキャリアの順位は？",
    publishedAt: "2025-02-18",
    category: "業界比較",
...
`
  ...
  {
    slug: "compare-saas",
    title: "【2026年】SaaS大手5社セキュリティ比較ランキング｜freee・SmartHRで最下位は？",
    description: "freee・SmartHR・Sansan・サイボウズ・マネーフォワードのWebセキュリティを10項目で採点しランキング化。最下位は意外にもあの企業…平均67点の衝撃結果と改善策を公開。",
    publishedAt: "2025-02-18",
    category: "業界比較",
