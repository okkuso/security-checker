...
const featuredSlugs = ["site-security-check-guide", "ssl-check-guide", "security-header-check-guide", "what-is-https"];
const foundationalSlugs = ["site-security-check-guide", "ssl-check-guide", "security-header-check-guide", "what-is-https", "what-is-hsts", "what-is-csp", "what-is-spf", "what-is-dmarc"];
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="grid gap-6">
        ...
        <LinkList
          title="基礎解説ガイド"
          description="SSLチェック・セキュリティヘッダーチェック・HTTPS・HSTS・CSP・SPF・DMARCなど、検索意図が明確な基礎解説記事です。"
