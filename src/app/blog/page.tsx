...
const foundationSlugs = ["site-security-check-guide", "ssl-check-guide", "security-header-check-guide", "dmarc-check-guide", "what-is-https", "what-is-dmarc", "what-is-spf", "what-is-csp", "what-is-hsts"];
    ...
    <main className="max-w-3xl mx-auto px-4 py-16">
      ...
      <section className="mb-10 rounded-2xl border border-zinc-200 bg-zinc-50 p-6">
        ...
        <p className="text-sm text-zinc-500 mb-4">
          露出が落ちている比較記事だけでなく、サイトのセキュリティチェック、SSLチェック、セキュリティヘッダーチェック、DMARC確認、HTTPS・DMARC・SPF・CSP・HSTS の基礎記事もまとめてたどれるようにしました。
