...
export const metadata: Metadata = {
  ...
  description: "HTTPS、HSTS、CSP、SPF、DKIM、DMARCの解説に加え、SaaS・通信・自動車など主要業界のセキュリティ比較記事を一覧で読めます。",
  alternates: {
    canonical: "/blog",
  },
  openGraph: {
    ...
    <main className="max-w-3xl mx-auto px-4 py-16">
      ...
      <section className="mb-10 rounded-2xl border border-zinc-200 bg-zinc-50 p-6">
        ...
        <p className="text-sm text-zinc-500 mb-4">
          露出が落ちている比較記事だけでなく、サイトのセキュリティチェック、SSLチェック、セキュリティヘッダーチェック、DMARC確認、SPFチェック、DKIM確認、HTTPS・DMARC・SPF・CSP・HSTS の基礎記事もまとめてたどれるようにしました。
